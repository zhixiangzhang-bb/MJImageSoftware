...
#include "ui_mjis_systemmessage.h"
...
namespace mjis {
    ...
    namespace hmi {
        ...
        //返回消息显示列表
        QPlainTextEdit* LogHandler::ReturnText()
        {
            return logTextEdit.get();
        }
            ...
            ui(new Ui::SystemMessage)
        {
            ...
            MessageLogging = std::make_shared<LogHandler>();
            google::AddLogSink(MessageLogging.get());
            ui->gridLayout_2->addWidget(MessageLogging->CreateText());
        }
