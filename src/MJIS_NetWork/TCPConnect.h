...
namespace mjis {
	...
	namespace net {
		...
		******************************************************************/
		...
		class MJIS_NetWork_API NetConnect : public QObject
		{
			Q_OBJECT
		public:
		...
		******************************************************************/
		...
		class  MJIS_NetWork_API ZTCPCilent : public NetConnect
		{
		...
		******************************************************************/
		...
		class  MJIS_NetWork_API ZTCPServer : public NetConnect
		{
